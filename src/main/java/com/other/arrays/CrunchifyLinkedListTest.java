 ...
 *With this kind of setup you’d use null for when you need an empty list. Think of “next” as being “the rest of the list”. 
 *In fact many people would call it “tail” instead of “next”.
 *
 *
 *
 */
public class CrunchifyLinkedListTest
{
	...
	public static void main(String[] args)
	{
		...
		crunchifyList.add("5");
		/*
		 * Please note that primitive values can not be added into LinkedList directly. They must be
		 * converted to their corresponding wrapper class.
		 */
...
class CrunchifyLinkedList
{
	...
	public void add(Object data)
	{
		...
		{
			// starting at the head node, crawl to the end of the list and then add element after
			// last node
